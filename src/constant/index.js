...
export const decimals = {
  amount: 2,
  fee:
    prodConfig.fee && (prodConfig.fee.decimals || prodConfig.fee.decimals === 0)
      ? prodConfig.fee.decimals
      : 2,
  shares: 4,
};
...
export const STATISTICAL = {
  LATEST_BLOCK_HEIGHT: 200,
  TRANSACTIONS_ID: 201,
  BLOCKS_ID: 202,
  AVG_BLOCK_TIME_ID: 203,
  ASSETS_ID: 204,
  DENOMS_ID: 205,
  I_SERVICES: 206,
  IDENTITIES_ID: 207,
  VALIDATOR_COUNT_ID: 208,
  BOND_TOKENS_ID: 209,
